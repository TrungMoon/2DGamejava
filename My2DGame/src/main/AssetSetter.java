...
public class AssetSetter {
	...
	public void setObject() {
		...
		/*
		 * gp.obj[3] = new OBJ_Door(gp); gp.obj[3].worldX = 10 * gp.titleSize;
		 * gp.obj[3].worldY = 11 * gp.titleSize;
		 * 
		 * gp.obj[4] = new OBJ_Door(gp); gp.obj[4].worldX = 8 * gp.titleSize;
		 * gp.obj[4].worldY = 28 * gp.titleSize;
		 * 
		 * gp.obj[5] = new OBJ_Door(gp); gp.obj[5].worldX = 12 * gp.titleSize;
		 * gp.obj[5].worldY = 22 * gp.titleSize;
		 * 
		 * gp.obj[6] = new OBJ_Chest(gp); gp.obj[6].worldX = 10 * gp.titleSize;
